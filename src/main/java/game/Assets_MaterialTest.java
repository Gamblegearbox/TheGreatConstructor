...
public class Assets_MaterialTest {
    ...
    public static float[] getUvForColorFromAtlas(int _x, int _y){
        ...
        uvCoords[0] = Assets_MaterialTest.TEXTURE_ATLAS_BORDER_OFFSET + Assets_MaterialTest.TEXTURE_ATLAS_COLOR_OFFSET * _x;
        uvCoords[1] = Assets_MaterialTest.TEXTURE_ATLAS_BORDER_OFFSET + Assets_MaterialTest.TEXTURE_ATLAS_COLOR_OFFSET * _y;
