...
public class MaterialTest implements IF_Game {
    ...
    public MaterialTest(Window _window) {
    ...
    public void init() throws Exception {
        ...
        scenes[0].addSceneObject("Test_Sphere0", new SimpleObject(Assets_MaterialTest.SPHERE, Assets_MaterialTest.SHADER_DEBUG_TEST));
        scenes[0].getSceneObjectByTag("Test_Sphere0").getTransform().setPosition(0,1.5f,0f);
        scenes[0].getSceneObjectByTag("Test_Sphere0").getTransform().setScale(1,1,1);

        scenes[0].addSceneObject("Test_Cube0", new SimpleObject(Assets_MaterialTest.CUBE, Assets_MaterialTest.SHADER_DEBUG_TEST));
        scenes[0].getSceneObjectByTag("Test_Cube0").getTransform().setPosition(0,-1.5f,0f);
        scenes[0].getSceneObjectByTag("Test_Cube0").getTransform().setScale(1,1,1);

        //HUD ITEMS
        hud = new Hud();
        TextItem text = new TextItem("Logging...", Assets_MaterialTest.FONT_CONSOLAS, Assets_MaterialTest.SHADER_HUD);
        text.getTransform().setPosition(Hud.LAYOUT_PADDING_X, Hud.LAYOUT_PADDING_Y, 0f);
        hud.addSceneObject("LoggedData", text);

        text = new TextItem("TIME: ", Assets_MaterialTest.FONT_CONSOLAS, Assets_MaterialTest.SHADER_HUD);
        text.getTransform().setPosition(Hud.LAYOUT_PADDING_X,Hud.LAYOUT_PADDING_Y + Hud.ROW_GAP + Assets_MaterialTest.FONT_CONSOLAS.getHeight(),0f);
        hud.addSceneObject("timeOfDay", text);

        text = new TextItem("LIGHT POS: ", Assets_MaterialTest.FONT_CONSOLAS, Assets_MaterialTest.SHADER_HUD);
        text.getTransform().setPosition(Hud.LAYOUT_PADDING_X,Hud.LAYOUT_PADDING_Y + 2 * (Hud.ROW_GAP + Assets_MaterialTest.FONT_CONSOLAS.getHeight()),0f);
        hud.addSceneObject("lightPos", text);

        text = new TextItem("MOUSE POS: ", Assets_MaterialTest.FONT_CONSOLAS, Assets_MaterialTest.SHADER_HUD);
        text.getTransform().setPosition(Hud.LAYOUT_PADDING_X,Hud.LAYOUT_PADDING_Y + 3 * (Hud.ROW_GAP + Assets_MaterialTest.FONT_CONSOLAS.getHeight()),0f);
