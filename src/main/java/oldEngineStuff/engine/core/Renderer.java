...
import oldEngineStuff.engine.interfaces.IHud;
...
import oldEngineStuff.engine.shading.ShaderProgram;
import oldEngineStuff.engine.utils.Utils;
import oldEngineStuff.game.Materials;
...
public class Renderer {
    ...
    public void renderScene(Scene scene)
    {
        if(EngineOptions.WIREFRAME_MODE)
        {
            ...
            // Render each mesh with the associated oldEngineStuff.game Items
