...
public class Renderer_OLD {
    ...
    public Renderer_OLD(Window _window)
    {
        this.window = _window;
    ...
    private void initShaders()
    {
        ...
        Assets.SHADER_SCENE.setUniformData("lightColor_sampler", Texture.RGBA_4);
        ...
        Assets.SHADER_SCENE_WATER.setUniformData("lightColor_sampler", Texture.RGBA_4);
